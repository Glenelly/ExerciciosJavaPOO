...
public class Teste {
    ...
    public static void consultarContato(Scanner scan, Agenda agenda){
        ...
        String nomeContato = leInformacaoString(scan, "Informe o nome do contato a ser pesquisado: ");
        try {
    ...
    public static void adicionarContato(Scanner scan, Agenda agenda){
        ...
        try{
            ...
            String nome = leInformacaoString(scan, "Insira o nome do contato:");
            String telefone = leInformacaoString(scan, "Insira o telefone do contato:");
            String email = leInformacaoString(scan, "Insira o email do contato:");
